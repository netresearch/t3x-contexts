...
class PageTest extends \TYPO3\CMS\Core\Tests\FunctionalTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->setUpFrontendRootPage(
            1,
            ['EXT:contexts/Tests/Functional/Fixtures/page.ts']
        );
    ...
    {
        $response = $this->getFrontendResponseOveride(1, ['test' => 1]);
     ...
     */
    protected function getFrontendResponseOveride($pageId, $arAdditionalArguments = [], $failOnFailure = true)
    {
        $pageId = (int) $pageId;
